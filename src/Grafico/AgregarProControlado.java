...
public class AgregarProControlado extends JFrame {
	...
	public AgregarProControlado() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(AgregarProControlado.class.getResource("/icon/agregar.png")));
		setResizable(false);
		Color color = new Color(118, 203, 222);
		setTitle("Agregar nuevo producto controlado");
		...
		fecha.getCalendarButton().setIcon(new ImageIcon(AgregarProControlado.class.getResource("/icon/calB.png")));
		...
		btnNewButton.setIcon(new ImageIcon(AgregarProControlado.class.getResource("/icon/cancel.png")));
		...
		btnAgregarProducto.setIcon(new ImageIcon(AgregarProControlado.class.getResource("/icon/agregar.png")));
		...
		btnAgregarProducto.setBounds(351, 451, 169, 35);

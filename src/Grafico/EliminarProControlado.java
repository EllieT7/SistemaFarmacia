...
public class EliminarProControlado extends JFrame {

	private JPanel contentPane;
	private int c=1;

	public EliminarProControlado(int cod,String pro) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(EliminarProControlado.class.getResource("/icon/basura.png")));
		setResizable(false);
		...
		msj.setText("Desea eliminar el producto "+pro+" de los productos controlados?");
		...
		btnNewButton.setIcon(new ImageIcon(EliminarProControlado.class.getResource("/icon/cancel.png")));
		...
		btnAgregarProducto.setIcon(new ImageIcon(EliminarProControlado.class.getResource("/icon/aceptar.png")));
			...
			public void actionPerformed(ActionEvent e) {
				if(c==1) {
					try {
						...
						PreparedStatement s;
						String query = "update producto set controlado = false where cod = ?";
